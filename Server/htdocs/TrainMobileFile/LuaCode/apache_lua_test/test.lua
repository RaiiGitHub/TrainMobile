...
package.path = 'D:/Program Files (x86)/HTTPD/htdocs/TrainMobileFile/LuaCode/apache_lua_test/?.lua;D:/Program Files (x86)/HTTPD/htdocs/TrainMobileFile/LuaCode/lib/?.lua'
require 'string'
...
function print_args(r, simple, complex)
  ...
  s = "    %s: "
 local utf8 = require 'utf8_tool'
 local cuge = "中国地质大学（北京）"

 for i, w, b in utf8.chars(cuge) do
    r:puts(w)
 end
